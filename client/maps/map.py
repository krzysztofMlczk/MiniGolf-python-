...
class Map:
    def __init__(self, id, space):
        ...
        self.obstacles = [
            Wall(space, (50, 800), (1230, 800), 6, 0.8),
            Wall(space, (50, 110), (1230, 110), 6, 0.8),
            Wall(space, (1230, 800), (1230, 110), 6, 0.8),
            Wall(space, (50, 110), (50, 800), 6, 0.8),
            Wall(space, (100, 300), (150, 240), 6, 0.8)
        ]
